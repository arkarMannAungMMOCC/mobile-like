...
import { sleep, validator } from "@helper";
    ...
    return <AuthLayout
        welcome={
            <div className="flex-1 flex flex-col justify-center items-center">
                ...
                <div className="text-[25px] text-title font-semibold md:text-2xl lg:text-3xl">
                    Welcome to
                </div>
                <div className="text-[25px] text-title font-semibold md:text-2xl lg:text-3xl">
                    Mobile Like
        ...
        form={
            <div className="flex flex-col p-[20px] md:px-[100px] lg:mb-[50px] lg:px-[350px] items-center">
                <div className="text-center mb-6"> 4 digit code has been <br /> sent to your phone number.</div>
                <InputComponent
                    label={'Confirm Code'}
                    value={code}
                    setValue={setCode}
                ...
                <ButtonComponent
                    ...
                    disable={loading}
                />
                <div onClick={goLoginPage} className="mt-3 text-[15px] cursor-pointer select-none">Already have an account ? Login</div>
            </div>
        }
    />;
}
export default memo(RecoveryConfirmScreen);